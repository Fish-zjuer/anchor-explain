...
const TARGETS = {
  ...
  'packages/extension-anchor/src/describe.ts': ['captureSummary'],
  'packages/extension-anchor/src/start/startModel.ts': [
    'StartActionSpec',
    'START_ACTIONS',
    'findStartAction',
    'StartModel',
  ...
  'packages/extension-anchor/src/start/StartViewProvider.ts': ['StartViewHandlers', 'StartViewProvider'],
  ...
  'packages/extension-anchor/src/start/ui/startHtml.ts': ['renderStartHtml'],
